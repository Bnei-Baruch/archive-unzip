...
def create_app(env, **kwargs):
    ...
    app.register_blueprint(doc2html.views.pdf2textBlueprint)
    app.register_blueprint(doc2html.views.html2textBlueprint)
    app.register_blueprint(doc2html.views.uid2textBlueprint)
